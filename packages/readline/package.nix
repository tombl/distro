...
let
  package = stdenv.mkDerivation (finalAttrs: {
    ...
    # Readline's abort and signal recovery paths use sigsetjmp/siglongjmp. On
    # wasm those only work when every translation unit with a call site is
    # compiled with the SjLj lowering.
