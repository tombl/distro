...
export const linuxVersion = await versionOf("@lowland/kernel");
export const bytesVersion = await versionOf("@lowland/bytes");
export const guestVersion = await versionOf("@lowland/guest");
